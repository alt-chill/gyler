...
module Gyler.FetchSpec.PushableBranchesQuerySpec (spec) where
...
import Gyler.FetchSpec.PushableBranchesQuery
...
spec :: Spec
spec = describe "Gyler.FetchSpec.PushableBranchesQuery" $ do
    it "PushableBranches parseValue works as expected" $ do
        input  <- BS.readFile "test/golden/FetchSpec/PushableBranches/input.txt"
